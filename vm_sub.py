...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("jmtravis/ipinfo")
    
    client.subscribe("jmtravis/dateinfo")

    client.subscribe("jmtravis/timeinfo")

    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("jmtravis/ipinfo", on_message_from_ipinfo)
    
    client.message_callback_add("jmtravis/dateinfo", on_message_from_dateinfo)

    client.message_callback_add("jmtravis/timeinfo", on_message_from_timeinfo)
